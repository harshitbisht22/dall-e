    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500]">
          Create imginavtive and visually stunning image throung DALL-E AI and
          share them with a community
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          />
          <div
            className="relative bg-gray-50 border-grey-300 
                text-gray-900 text-sm rounded-lg focus:ring-blue-500
                focus:boder-b  ue-500 w-64 p-3 h-64 flex justify-center items-center"
          >
            {form.photo ? (
              <img
                src={form.photo}
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#666e75] text-[14px]">
            Once You have Created an Image you want , you cab share it with
